    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 order-md-1">
                ...
                <form class="needs-validation" novalidate="" action="{{ route('flights.update', $data['id']) }}" method="post" autocomplete="off">
                    @method('PATCH')
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('long') is-invalid @enderror" name="long" placeholder="-74.046057"
                                   value="{{ old('long') ? old('long') : $data['lat']  }}" required="">
                            <div class="invalid-feedback">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control"  @error('duration_in_seconds') is-invalid @enderror name="duration_in_seconds" placeholder="600"
                                   value="{{ old('duration_in_seconds') ? old('duration_in_seconds') : $data['duration_in_seconds']  }}" required="">
                            <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea  class="form-control @error('notes') is-invalid @enderror" name="notes" required="">{{ old('duration_in_seconds') ? old('duration_in_seconds') : $data['notes']  }} </textarea>
                        <div class="invalid-feedback">
                            Please enter notes.
                        </div>
                    </div>
                    ...
                    <hr class="mb-4">
                    <button class="btn btn-primary btn-lg btn-block" id="submit" type="submit">Update a Flight</button>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        $(function() {
            ...
            $('input[name="flight_time"]').daterangepicker({
                ...
                startDate: '{{date('m/d/Y H:m a',strtotime($data['flight_time']))}}',
